      ...
      <div className="mb-2">
        ...
        <div className="flex flex-col space-y-2">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <span className="text-gray-700 font-medium">Email:</span>
              <span className="text-gray-600">{donorCredential.email}</span>
            </div>

            <Button
              variant={"link"}
              onClick={() =>
                handleCopy(donorCredential.email, setCopiedUserEmail)
              }
            >
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <span className="text-gray-700 font-medium">Password:</span>
              <span className="text-gray-600">{donorCredential.password}</span>
            </div>
            <Button
              variant={"link"}
              onClick={() =>
                handleCopy(donorCredential.password, setCopiedUserPassword)
              }
            >
